...
import wombatukun.tests.test11.orderservice.exceptions.RegistrationNotAllowedException;
...
public class GlobalExceptionHandler {
	...
	public CommonResponse handleRegistrationNotAllowed(RegistrationNotAllowedException exception) {
		return CommonResponse.failure(exception.getMessage());
	}
