package wombatukun.tests.test11.gateway.exceptios.handlers;
...
import wombatukun.tests.test11.gateway.exceptios.GlobalErrorAttributes;
...
public class GlobalErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ...
        return ServerResponse.status(HttpStatus.valueOf(statusCode))
                ...
                .body(BodyInserters.fromValue(CommonResponse.failure(errorPropertiesMap.get("message").toString())));
    }
}
